...
class ACSviewer(QtWidgets.QMainWindow, main_ACS.Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.details.clicked.connect(lambda : self.dockWidget.show())
        spacer = QtWidgets.QWidget()
        spacer.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        self.toolBar.addWidget(spacer)
        self.toolBar.addWidget(self.run)
        self.statusbar.addWidget(self.details)
        ...
        self.actionDetails.triggered.connect(self.Machdetails)

        self.listView_2.addAction(self.actionHide)
        self.listView_2.addAction(self.actionUnhide)
        self.listView_2.addAction(self.actionDetails)
